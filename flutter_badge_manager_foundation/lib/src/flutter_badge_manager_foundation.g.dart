...
class FlutterBadgeManagerApi {
  ...
  Future<bool?> isSupported() async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.flutter_badge_manager_foundation.FlutterBadgeManagerApi.isSupported$pigeonVar_messageChannelSuffix';
  ...
  Future<void> update(int count) async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.flutter_badge_manager_foundation.FlutterBadgeManagerApi.update$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
  ...
  Future<void> remove() async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.flutter_badge_manager_foundation.FlutterBadgeManagerApi.remove$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel =
        BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
